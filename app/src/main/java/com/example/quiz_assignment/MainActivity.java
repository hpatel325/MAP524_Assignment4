...
//
    ...
    private void showLanguageDialog() {
        ...
        TextView tvChinese = dialogView.findViewById(R.id.tvChinese);

        String selectedLanguage = LocaleHelper.getLanguage(this);

        if (selectedLanguage.equals("ch")) {
            tvEnglish.setBackgroundColor(Color.TRANSPARENT);
            tvEnglish.setTextColor(Color.BLACK);
            tvChinese.setBackgroundColor(getResources().getColor(R.color.purple_500));
            tvChinese.setTextColor(Color.WHITE);
        } else {
            ...
            tvChinese.setBackgroundColor(Color.TRANSPARENT); // Set no background for Chinese
            tvChinese.setTextColor(Color.BLACK); // Change text color for Chinese
        }
